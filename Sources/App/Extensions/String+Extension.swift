...
extension String {
    ...
    /// This function checks whether the string is a valid IP address or not.
    /// - Returns: A Boolean value indicating whether the string is a valid IPv4/IPv6 address (true) or not (false).
    func isIPAddress() -> Bool {
        ...
        return self.range(of: ipV4regex, options: .regularExpression) != nil || self.range(of: ipV6Regex, options: .regularExpression) != nil
    }
